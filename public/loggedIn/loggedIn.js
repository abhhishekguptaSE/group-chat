...
logOut.addEventListener("click", (e) => {
  ...
  location.replace("http://localhost:5000/public/login/login.html");
});
...
export async function renderChat(groupName, groupId) {
  main_chat.innerHTML = `<div class="table-responsive" style="overflow-x:auto;" id="table">
...
window.sendFileToBackend = async function sendFileToBackend(
  groupId,
  groupName
) {
